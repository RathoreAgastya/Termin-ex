...
# this is like the calculator.py file, it is going to be a abandoned file
# i could have just ord it
# This my lieeeeeeeeeeeeeeeeeeefe
# I don't even know how much time i had spent to write the entire code
